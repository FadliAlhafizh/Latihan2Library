package com.example.latihan2library;
...
public class MainActivity extends AppCompatActivity {
    ...
    final private int REQUEST_CODE_ASK__PERMISSIONS = 111;
    ...
    private void createPdfWrapper() throws FileNotFoundException,DocumentException{
        int hasWriteStoragePermission = ActivityCompat.checkSelfPermission
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
                                           int[] grantResults){
        switch (requestCode) {
            case REQUEST_CODE_ASK__PERMISSIONS:
